...
const Product = ({ id, setError, setLoading, clear, imgHeight = "h-72", descHeight = "h-40", editdelete = true }: any) => {
      ...
      <p className="group">
        <div className="aspect-w-1 aspect-h-1 w-full overflow-hidden bg-white xl:aspect-w-7 xl:aspect-h-8 ">
          ...
          <img
            src={product.image}
            alt={"image"}
            className={`${imgHeight} w-full rounded-t-md  object-cover object-center group-hover:opacity-75`}
          />
            ...
            {editdelete && 
              address === product.owner ? (
                <div className="flex flex-row">
                  ...
                  <span className="ml-2">* This is your product</span>
                </div>
              ) : <div className="mt-1"><br/></div>
            }
            <div className={`${descHeight} overflow-y-hidden scrollbar-hide`}>
