    ...
    <div className={"flex flex-row w-full justify-between"}>
      <div>
        ...
        <button
          ...
          className="inline-block ml-4 px-6 py-2.5 mt-8 bg-black text-white font-medium text-md leading-tight rounded-2xl shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out"
          data-bs-toggle="modal"
          data-bs-target="#exampleModalCenter"
        >
          Random Product
        </button>
         <p className="ml-2">* Let the system choose your product</p>
        {/* Modal */}
        {visible && (
          <div
